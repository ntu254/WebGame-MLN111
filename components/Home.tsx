...
export const Home: React.FC<HomeProps> = ({ onStart }) => {
    return (
        <div className="h-full w-full overflow-y-auto bg-slate-950 p-6 md:p-12 scrollbar-thin scrollbar-thumb-slate-800">
            <div className="max-w-6xl mx-auto space-y-16 animate-in fade-in duration-700 slide-in-from-bottom-4">
                ...
                <div className="text-center space-y-6 relative py-12">
                    ...
                    <h1 className="text-5xl md:text-7xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-200 to-slate-400 tracking-tight leading-tight">
                        NHÀ TƯ DUY TRẺ<br />
                    ...
                    <div className="flex justify-center gap-4 pt-4">
                        <button
                            onClick={() => onStart(1)}
                            className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-3 rounded-lg font-bold text-lg transition-all shadow-lg hover:shadow-blue-500/25 flex items-center gap-2 group"
                        >
                            <Play size={20} className="fill-white group-hover:scale-110 transition-transform" />
                            KHỞI ĐỘNG CỖ MÁY
                        </button>
                        <button className="bg-slate-800 hover:bg-slate-700 text-slate-200 px-8 py-3 rounded-lg font-bold text-lg transition-all border border-slate-700 hover:border-slate-500 flex items-center gap-2">
                            <BookOpen size={20} />
                            HƯỚNG DẪN
                        </button>
                    </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {/* Level 1 Card */}
                    <div className="group relative bg-slate-900/50 hover:bg-slate-900 border border-slate-800 hover:border-blue-500/50 rounded-2xl p-8 transition-all duration-300 hover:-translate-y-2">
                        ...
                        <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center mb-6 shadow-lg shadow-blue-500/20 group-hover:scale-110 transition-transform duration-500">
                            <Zap size={32} className="text-white" />
                        </div>

                        <h3 className="text-2xl font-bold text-white mb-2">Cấp độ 1: Vật Chất</h3>
                        <p className="text-blue-400 font-mono text-sm mb-4 uppercase tracking-wider">Phân loại Thực tại</p>
                    ...
                    {/* Level 2 Card */}
                    <div className="group relative bg-slate-900/50 hover:bg-slate-900 border border-slate-800 hover:border-purple-500/50 rounded-2xl p-8 transition-all duration-300 hover:-translate-y-2">
                        ...
                        <div className="w-14 h-14 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center mb-6 shadow-lg shadow-purple-500/20 group-hover:scale-110 transition-transform duration-500">
                            <Brain size={32} className="text-white" />
                        </div>

                        <h3 className="text-2xl font-bold text-white mb-2">Cấp độ 2: Ý Thức</h3>
                        <p className="text-purple-400 font-mono text-sm mb-4 uppercase tracking-wider">Nguồn gốc Tư duy</p>
                    ...
                    {/* Level 3 Card */}
                    <div className="group relative bg-slate-900/50 hover:bg-slate-900 border border-slate-800 hover:border-cyan-500/50 rounded-2xl p-8 transition-all duration-300 hover:-translate-y-2">
                        ...
                        <div className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-green-500 rounded-xl flex items-center justify-center mb-6 shadow-lg shadow-cyan-500/20 group-hover:scale-110 transition-transform duration-500">
                            <Building2 size={32} className="text-white" />
                        </div>

                        <h3 className="text-2xl font-bold text-white mb-2">Cấp độ 3: Biện Chứng</h3>
                        <p className="text-cyan-400 font-mono text-sm mb-4 uppercase tracking-wider">Xã hội & Vận động</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12 border-t border-slate-800/50">
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-900/30">
                        ...
                        <div>
                            <h4 className="font-bold text-white mb-1">Xếp hạng & Thành tích</h4>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-900/30">
                        ...
                        <div>
                            <h4 className="font-bold text-white mb-1">Hỗ trợ bởi AI</h4>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-900/30">
                        ...
                        <div>
                            <h4 className="font-bold text-white mb-1">Chuẩn kiến thức</h4>
